...
<div class="container">
  <div class="row">
  	...
  	<h2 style="margin-top: 0px; font-size: 20px" class="hidden-xs">Jadwal sholat hari ini</h2>
  		...
  		<p>Subuh <span class="subuh_dr"></span> derajat, Isya <span class="isya_dr"></span></p>
...
<script type="text/javascript">
	...
	function load_Kalender(latitude,longitude,timezone) {
			...
			//jQuery(function($) {
			 $.getJSON(' http://api.aladhan.com/calendar?latitude='+ latitude +'&longitude='+ longitude +'&timezonestring='+ timezone +'&month=<?=date('m')?>&year=<?=date('Y')?>&method=4&latitudeAdjustmentMethod=3', function (response)
			 {
